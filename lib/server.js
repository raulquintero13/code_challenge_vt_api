...
app.get("/v1/students/with-certification/show/email", (req, res) => {
    res.json(StudentController.getStudentsWithCertification());
});

app.get("/v1/students/score-greater-than", (req, res) => {
    res.json(StudentController.getStudentsScoreGreaterThan());
});
